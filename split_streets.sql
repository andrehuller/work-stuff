...
BEGIN
	...
	THEN
		INSERT	INTO streetbase.tb_geo_eixos_viarios_separados_pol_p4674(city_id, geom,
			oneway, max_speed, avg_speed)
		SELECT	city_id::integer, streetbase.GEO_Split_Street(ST_Simplify(geom, 0.000044965)),
			oneway, max_speed, avg_speed
		FROM	streetbase.tb_geo_street_pol_p4674_a2016_v4
		WHERE	city_id = a_city_id::text
		AND	st_no = 'Sem Nome';
